  ...
  <header id="header" class="fixed-top  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      <nav id="navbar" class="navbar">
        ...
        <ul>
          <li><a class="nav-link scrollto active" href="leads.php"><strong>
                <bold>Leads</bold>
              </strong></a></li>
          ...
          <li><a class="nav-link scrollto" href="#main"><strong>
              ...
              <li><a class="nav-link scrollto" href="Addadmin.php"><strong>
                <bold>Add Admin</bold>
              </strong></a></li>
          ...
          <div class="modal-body">
            <form>
              ...
              <div class="mb-3">
                ...
                <input type="Contact number" class="form-control">
              </div>
            </form>
          </div>
